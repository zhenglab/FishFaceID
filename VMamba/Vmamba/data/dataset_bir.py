...
def make_dataset(
    ...
    instances = []
    instances_file_path = os.path.join(directory, "annotation/{}/annotation-{}/split-{}/{}.txt".format(prefix, subset, anno_split, split))
...
class DatasetFolder(VisionDataset):
    ...
    def __init__(
        ...
        classes, class_to_idx = self.find_classes("{}/annotation/{}/annotation-{}/split-{}".format(self.root, prefix, subset, anno_split))
        samples = self.make_dataset(self.root, split, subset, anno_split, prefix, class_to_idx, extensions, is_valid_file)
    ...
    def make_dataset(
        ...
        return make_dataset(directory, split, subset, anno_split, prefix, class_to_idx, extensions=extensions, is_valid_file=is_valid_file)
