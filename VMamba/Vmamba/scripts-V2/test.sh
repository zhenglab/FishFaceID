...
cd /mnt/8TDisk1/zhenglab/sunnaizhe/OUC-MOI-ID/deit-98d-V2
NNODES=${NNODES:-1}
...
ROOT_PATH=/mnt/8TDisk1/zhenglab/sunnaizhe/OUC-MOI-ID/deit-98d-V2
...
--finetune /mnt/8TDisk1/zhenglab/sunnaizhe/OUC-MOI-ID/deit_dev/output/pretrain/deit_tiny_patch16_224.pth \
